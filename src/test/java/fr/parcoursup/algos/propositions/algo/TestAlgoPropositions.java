...
public class TestAlgoPropositions { // A terme, il faudra peut-être inclure les codes et les tests de
    ...
    public void calcule_doit_reussir_siVerifierEstFalse() throws Exception {
        ...
        final GroupeAffectation groupeAffectation = new GroupeAffectation(1, groupeAffectationUID, 0, 0, 0, p);
        ...
        voeux.add(new Voeu(1, groupeAffectation.id, 1, 1, groupeInternat.id, 1, 1, StatutVoeu.EN_ATTENTE_DE_PROPOSITION, false));
        voeux.add(new Voeu(2, groupeAffectation.id, 2, 2, groupeInternat.id, 2, 2, StatutVoeu.EN_ATTENTE_DE_PROPOSITION, false));
    ...
    public void calcule_doit_reussir_siCandidatsAvecRepondeurAutomatiqueEtAutreCandidatAffecteHorsPP() throws Exception {
        ...
        final List<Voeu> voeux = new ArrayList<>();
        voeux.add(new Voeu(1, groupeAffectation.id, 1, 1, groupeInternat.id, 1, 1, StatutVoeu.PROPOSITION_JOURS_PRECEDENTS_ACCEPTEE, true));
        voeux.add(new Voeu(2, groupeAffectation.id, 2, 2, groupeInternat.id, 2, 2, StatutVoeu.EN_ATTENTE_DE_PROPOSITION, false));
        voeux.add(new Voeu(3, groupeAffectation.id, 3, 3, groupeInternat.id, 3, 3, StatutVoeu.EN_ATTENTE_DE_PROPOSITION, false));
    ...
    public void calcule_doit_reussir_siRepondeurLiberePlaces() throws Exception {
        ...
        final GroupeAffectation g1 = new GroupeAffectation(1, new GroupeAffectationUID(0, 0, 0), 1, 1, 0, p);
        final GroupeAffectation g2 = new GroupeAffectation(1, new GroupeAffectationUID(1, 1, 1), 1, 1, 0, p);

        final List<Voeu> voeux = new ArrayList<>();
        Voeu v1 = new Voeu(1, false, g1.id, 1, 1, 2, StatutVoeu.EN_ATTENTE_DE_PROPOSITION, false);
